...
const TEAM: TeamMember[] = [
  ...
  },
  {
    id: 3,
    name: "Ananya Sharma",
    position: "AI & Machine Learning Lead",
                  ...
                  return (
                    ...
                    >
                      ...
                      <motion.button
                        ...
                        className={`w-12 h-12 md:w-14 md:h-14 rounded-2xl flex items-center justify-center border transition-all duration-300 relative ${
                          isSelected
